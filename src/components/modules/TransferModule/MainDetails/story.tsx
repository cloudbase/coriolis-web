...
storiesOf('MainDetails', module)
  .add('default', () => (
    <div style={{ width: '800px' }}><MainDetails endpoints={[]} item={{}} {...props} /></div>
  ))
  .add('loading', () => (
    <div style={{ width: '800px' }}><MainDetails loading endpoints={[]} item={{}} {...props} /></div>
  ))
  .add('openstack -> azure', () => (
    <div style={{ width: '800px' }}><MainDetails endpoints={endpoints} item={item} {...props} /></div>
  ))
