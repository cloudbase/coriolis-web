...
> {
  ...
  handleStoreChange(alerts: AlertInfo[]) {
    ...
    let action = lastNotification.options
      ? lastNotification.options.action
      : undefined;
    ...
    this.notificationSystem.addNotification({
      ...
      onAdd: notification => {
        ...
        for (
          let i = 0;
          i < this.activeNotifications.length - MAX_NOTIFICATIONS;
          i += 1
        ) {
