...
storiesOf('MigrationDetailsContent', module)
  .add('default', () => (
    <MigrationDetailsContent item={item} endpoints={endpoints} page="" {...props} />
  ))
  .add('details loading', () => (
    <MigrationDetailsContent item={item} endpoints={endpoints} page="" detailsLoading {...props} />
  ))
  .add('tasks', () => (
    <MigrationDetailsContent item={item} endpoints={endpoints} page="tasks" {...props} />
  ))
